...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	                ...
	                columns: [
	                    {
	                        ...
	                        formatter: function (value, row) {
	                            ...
	                            if (value.length>7){
	                                ...
	                                return "<nobr>" +
	                                    "<a title = '"+value+"' href='${ctx}/familyMatters/afterMarriageForm?id=" + row.id + "'>" + manager + "</a>"
	                                    + "</nobr>"
	                            }else{
	                                return "<nobr>" +
	                                    "<a href='${ctx}/familyMatters/afterMarriageForm?id=" + row.id + "'>" + value + "</a>"
	                                    + "</nobr>"
	                            }
	        ...
	        //新增
	        function add() {
	            window.location.href = "${ctx}/familyMatters/afterMarriageForm";
	        }
		...
		<div>
		    <form:form id="searchForm" modelAttribute="familyMatters" action="${ctx}/familyMatters/list" method="post">
		    	...
		    	<div class="controls controls-row">
		            ...
		            <div class="search-div input-prepend input-append margin-left-1">
		                <span class="add-on">报告事项</span>
		                <form:input cssClass="search-input-medium" path="matters" htmlEscape="false" maxlength="50" />
		            </div>
		        </div>
		        <div class="controls controls-row">
		        	<div class="search-div input-prepend input-append">
