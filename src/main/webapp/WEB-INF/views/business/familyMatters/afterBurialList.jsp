...
<html>
	<head>
	    ...
	    <script type="text/javascript">
	                ...
	                columns: [
	                    {
	                        ...
	                        formatter: function (value, row) {
	                            ...
	                            if (value.length>7){
	                                ...
	                                return "<nobr>" +
	                                    "<a title = '"+value+"' href='${ctx}/familyMatters/afterBurialForm?id=" + row.id + "'>" + manager + "</a>"
	                                    + "</nobr>"
	                            }else{
	                                return "<nobr>" +
	                                    "<a href='${ctx}/familyMatters/afterBurialForm?id=" + row.id + "'>" + value + "</a>"
	                                    + "</nobr>"
	                            }
	                        }
	                    }, {
	        ...
	        //新增
	        function add() {
	            window.location.href = "${ctx}/familyMatters/afterBurialForm";
	        }
