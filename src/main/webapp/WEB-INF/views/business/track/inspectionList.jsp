...
//                    },
                    {
                        ...
                        formatter: function (value, row) {
                            ...
                            if (value.length>5){
                                ...
                                return "<nobr>" +
                                    "<a title = '"+value+"' href='${ctx}/track/form?id=" + row.id + "'>" + manager + "</a>"
                                    + "</nobr>"
                            }else{
                                return "<nobr>" +
                                    "<a href='${ctx}/track/form?id=" + row.id + "'>" + value + "</a>"
                                    + "</nobr>"
                            }
...
//                        sortName: 'UPDATE_DATE'
        ...
        // 新添
        function add() {
            window.location.href = "${ctx}/track/form";
        }
        function delect() {
        ...
        function update(id) {
                window.location.href = "${ctx}/track/form?id="+id;
        }
        function saveSort() {
        ...
        function exportExcel() {
            confirmx('确认要导出数据吗？',function(){
                ...
                window.location.href="${ctx}/track/exportExcel?ids="+ids+"&"+decodeParams;
            },'')
        }
    </script>
    <style type="text/css">
...
<body>
<ul class="breadcrumb">
    <li class="active">跟踪督查</li>

</ul>
<div>
    <form:form id="searchForm" modelAttribute="specialSupervision" action="${ctx}/track/list" method="post">
        <div class="controls controls-row">
            <div class="search-div input-prepend input-append">
                <span class="add-on">关联来源</span>
                <form:input cssClass="search-input-medium" path="source" htmlEscape="false" maxlength="50" />
