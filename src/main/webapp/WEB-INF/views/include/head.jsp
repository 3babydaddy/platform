...
<script src="${ctxStatic}/jquery/jquery-1.11.3.js" type="text/javascript"></script>
<script src="${ctxStatic}/jquery/jquery-migrate-1.4.1.js" type="text/javascript"></script>
<link href="${ctxStatic}/bootstrap/2.3.1/css_united/bootstrap.css" type="text/css" rel="stylesheet" />
...
<script src="${ctxStatic}/bootstrap-table/bootstrap-table-zh-CN.min.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/common/tfkj.js" type="text/javascript"></script>
<script src="${ctxStatic}/common/tfkjTable.js" type="text/javascript"></script>
<script type="text/javascript" src="${ctxStatic}/jquery-form/ajaxfileupload.js?version=3.2.6"></script>

<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';</script>
<!-- 前端导出excel -->
<%-- <script src="${ctxStatic}/bootstrap-table/export/bootstrap-table-export.js"></script>
<script src="${ctxStatic}/bootstrap-table/export/tableExport.js"></script> --%>