...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="showFlag" items="${fns:getDictList('show_hide')}" itemLabel="chname" itemValue="enname" htmlEscape="false" class="required"/>
		...
		<div class="control-group">
            ...
            <div class="controls">
                <form:checkboxes path="hrefTypeList" items="${fns:getDictList('sys_user_type')}" itemLabel="chname" itemValue="enname" htmlEscape="false" class="required"/>
            </div>
        </div>
		<div class="control-group">
