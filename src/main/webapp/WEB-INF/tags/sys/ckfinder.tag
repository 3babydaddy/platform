...
<script type="text/javascript">
	...
	function ${input}Preview(){
		...
		if ($("#${input}Preview").text() == ""){
			$("#${input}Preview").html("<li onclick='${input}FinderOpen();' style='list-style:none;padding-top:5px;'>${empty text ? '上传附件' : text}</li>");
		}
	}
	${input}Preview();
</script>