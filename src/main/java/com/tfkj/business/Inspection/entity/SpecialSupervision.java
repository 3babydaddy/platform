...
public class SpecialSupervision extends DataEntity<SpecialSupervision> {
...
//批评单位
  ...
  @ExcelField(align = 2, type = 0, sort = 1000, title = "任务类型")
  ...
  public String getInspectionDateShow() {
	  String manager = "";
      if (StringUtil.isNotEmpty(inspectionDate)){
          manager += inspectionDate ;
      };
      if(StringUtil.isNotEmpty(inspectionDate)&&StringUtil.isNotEmpty(inspectionEndDate)){
          manager += "至";
      }
      if (StringUtil.isNotEmpty(inspectionEndDate)){
          manager +=inspectionEndDate;
      }
      return manager;
	  }
  ...
  @ExcelField(align = 2, type = 0, sort = 5000, title = "带队领导")
  public String getLeadLeaderTextShow() {
  ...
  public String getLeadLeaderText() {
	    return DictUtils.getLeadName(this.leadLeader);
	  }

  @ExcelField(align = 2, type = 0, sort = 6000, title = "参加单位")
  public String getJoinCompanyTextShow() {
	  String company=DictUtils.getOfficeName(this.joinCompany);
	  String manager = "";
      if (StringUtil.isNotEmpty(company)){
          String[] array = company.split(",|，|、");
          if(array.length>1){
  ...
  @ExcelField(align = 2, type = 0, sort = 7000, title = "被督查单位")
  public String getInspectionRangeShow() {
	  String manager = "";
  ...
  @ExcelField(align = 2, type = 0, sort = 8000, title = "报告形式")
