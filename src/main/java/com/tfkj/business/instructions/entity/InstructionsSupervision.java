package com.tfkj.business.instructions.entity;
...
public class InstructionsSupervision extends DataEntity<InstructionsSupervision> {

  private static final long serialVersionUID = 1L;

  //关联多个list
  private List<InstructionsRelationPo> instructionsRelationPoList;
  // 是否后续跟踪
...
//批评单位
  ...
  public List<InstructionsRelationPo> getInstructionsRelationPoList() {
    return instructionsRelationPoList;
  }

  public void setInstructionsRelationPoList(List<InstructionsRelationPo> instructionsRelationPoList) {
    this.instructionsRelationPoList = instructionsRelationPoList;
  }
  ...
  public String getRelationTaskName() {
    Map<String,String> map = DictUtils.getRelationName(this.relationTask);
    this.relationTask = map.get("ids");
    return map.get("name");
  }
  ...
  @ExcelField(align = 2, type = 0, sort = 4000, title = "核查时间")
  ...
  @ExcelField(align = 2, type = 0, sort = 2000, title = "核查事项")
  ...
  @ExcelField(align = 2, type = 0, sort = 5000, title = "核查单位")
