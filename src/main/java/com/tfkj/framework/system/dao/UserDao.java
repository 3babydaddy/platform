...
public interface UserDao extends CrudDao<User> {
	...
	/**
	 * @Title: modifyDataForChangeReason
	 * @Description: 根据变更原因逻辑删除数据
	 * @param @param office 参数
	 * @return void 返回类型
	 * @throws
	 */
	void modifyDataForChangeReason(User user);

	/**
	 * @Title: getByOfficeId
	 * @Description: 根据单位ID查询用户信息
	 * @param @param officeId
	 * @param @return 参数
	 * @return User 返回类型
	 * @throws
	 */
	User getByOfficeId(@Param("officeId") String officeId);
